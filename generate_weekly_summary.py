...
_SUMMARY_STYLE        = str(_cfg.get("weekly_summary_style")        or _cfg.get("summary_style",        "narrative")).lower()
_SUMMARY_WORD_LIMIT   = int(_cfg.get("weekly_summary_word_limit")   or _cfg.get("summary_word_limit",   130))
_SUMMARY_BULLET_COUNT = int(_cfg.get("weekly_summary_bullet_count") or _cfg.get("summary_bullet_count", 5))
